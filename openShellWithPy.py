    ...
    def start_controller():
        ...
        match sys.platform:
            case "win32":
                ...
                stdin, stdout, stderr = client.exec_command(f"sudo mn -c \n sudo cp /media/sf_NGN_Project/Simple_Switch_stp_CRISTIANO.py /home/vagrant/comnetsemu_dependencies/ryu-v4.34/ryu/ryu/app/CRISTIANO.py \n cd /home/vagrant/comnetsemu_dependencies/ryu-v4.34/ryu/ryu/app/ \n sudo ryu-manager CRISTIANO.py", timeout=20)
